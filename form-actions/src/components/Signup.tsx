...
function signupAction(prevFormState: any, formData: FormData) {
    ...
    <form action={formAction}>
      ...
      <div className="control-row">
        <div className="control">
          ...
          <input
            ...
            id="first-name"
            name="first-name"
            defaultValue={formState.enteredValues?.firstName?.toString()}
          />
        </div>
        ...
        <div className="control">
          ...
          <input
            ...
            id="last-name"
            name="last-name"
            defaultValue={formState.enteredValues?.lastName?.toString()}
          />
        </div>
      </div>
      ...
      <div className="control">
        ...
        <select
          id="role"
          name="role"
          defaultValue={formState.enteredValues?.role?.toString()}
        >
